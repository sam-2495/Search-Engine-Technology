...
public class DirectoryCorpus implements DocumentCorpus {
    ...
    public static DirectoryCorpus loadXMLDirectory(Path absolutePath, String fileExtension) {
        DirectoryCorpus corpus = new DirectoryCorpus(absolutePath);
        corpus.registerFileDocumentFactory(fileExtension, XmlFileDocument::loadXMLFileDocument);
        return corpus;
    }
}
