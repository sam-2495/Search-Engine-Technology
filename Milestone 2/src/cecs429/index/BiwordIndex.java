...
public class BiwordIndex {
	...
	/*
	 * public static Set<Integer> getPostings(String term) { return
	 * invertedIndexMap.get(term); }
	 */
	...
	public static Map<String, Set<Integer>> getInvertedIndexMap() {
		return invertedIndexMap;
	}

	public static void setInvertedIndexMap(Map<String, Set<Integer>> invertedIndexMap) {
		BiwordIndex.invertedIndexMap = invertedIndexMap;
	}
