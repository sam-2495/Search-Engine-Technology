...
import cecs429.index.XMLIndexer;
...
public class BetterTermDocumentIndexerWithPositionalInvertedIndex {
	...
	public static String docWeightsFile = "/Users/samarthyadav/Desktop/Milestone 2/Index_Disk/docWeights.bin/";
	public static String soundexFile = "/Users/samarthyadav/Desktop/Milestone 2/Index_Disk/soundex.bin/";
	public static String biwordIndexFile = "/Users/samarthyadav/Desktop/Milestone 2/Index_Disk/biwordIndex.bin/";
	public static String diskIndexPath = "/Users/samarthyadav/Desktop/Milestone 2/Index_Disk/Postings.bin/";
	public static String folderName;
	//main method
	public static void main(String[] args) throws IOException {
		System.out.print("Enter corpus path to index : ");
		folderName = scanner.nextLine();
		DocumentCorpus corpus = extractCorpus(folderName);
...
//			query = query.toLowerCase();
	...
	// Method to index a XML corpus(own corpus)
	private static Index xmlIndexer(String query) throws IOException {
		Index index;
		String fileToIndex = query.replace(":xml", "").trim();
		XmlToObject xmlToObject = new XmlToObject();
		feed = xmlToObject.getDataFromXMLFile(fileToIndex);
		index = XMLIndexer.indexXmlCorpus(feed);
		DiskIndexWriter.createBinaryFile(index, BetterTermDocumentIndexerWithPositionalInvertedIndex.biwordIndexFile);
		BiwordIndexer.biwordXmlIndexCorpus(feed);
		corpusType = "XML";
		return index;
	}
