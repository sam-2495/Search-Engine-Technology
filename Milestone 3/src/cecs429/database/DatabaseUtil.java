...
public class DatabaseUtil {
	...
	public DatabaseUtil() {
		String indexFile = "/Users/samarthyadav/Desktop/MLP3 DT/dpIndex.db";
		if (postingsDB == null) {
		...
		String biwordFile = "/Users/samarthyadav/Desktop/MLP3 DT/biwordIndex.db";
		if (biwordDB == null) {
		...
		String docWeightsFile = "/Users/samarthyadav/Desktop/MLP3 DT/docWeights.db";
	...
	public static void saveSoundexToDB(Map<String, Integer> soundexMap) {
		String fileName = "/Users/samarthyadav/Desktop/MLP3 DT/soundex.db";
...
//			e.printStackTrace();
	...
	public int getSoundexFromDB(String soundex) {
		String soundexFile = "/Users/samarthyadav/Desktop/MLP3 DT/soundex.db";
		try {
			if (soundexDB == null) {
...
//			e.printStackTrace();
	...
	public static void saveTermIndexToDB(Map<String, Integer> indexMap) {
		String fileName = "/Users/samarthyadav/Desktop/MLP3 DT/dpIndex.db";
		DB db = null;
		BTreeMap<String, Integer> map = null;
		try {
...
//			System.out.println("Some Error Occured in getTermIndexFromDB.");
	...
	public static void saveBiwordIndexToDB(Map<String, Integer> indexMap) {
		String fileName = "/Users/samarthyadav/Desktop/MLP3 DT/biwordIndex.db";
		DB db = null;
		BTreeMap<String, Integer> map = null;
		try {
			db = DBMaker.fileDB(fileName).make();
	...
	public static void saveDocWeightsToDB(Map<Integer, Integer> indexMap) {
		String fileName = "/Users/samarthyadav/Desktop/MLP3 DT/docWeights.db";
		DB db = null;
